...
int main(int argc, char* argv[])
{
    ...
    cout << "====This is on the first board====" << endl;
    ...
    string plain2 = output2;
    string cipher2, encoded2, recovered2;   
    
    cout << "====This is on the second board====" << endl;

    try
    {
        cout << "plain text: " << plain2 << endl;
        CBC_Mode< AES >::Encryption e;
        e.SetKeyWithIV( key, sizeof(key), iv );

        StringSource( plain2, true,
            new StreamTransformationFilter( e,
    ...
    cout << "cipher text: " << encoded2 << endl;
    ...
    try
    {
        ...
        cout << "decrypted text: " << recovered2 << endl;
    }
    catch( CryptoPP::Exception& e )
    {
        cerr << "Caught Exception..." << endl;
