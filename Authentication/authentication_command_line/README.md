Step 0 is a flow chart that shows the high level authentication method. From step 1 - 23, the steps of each authentication process is illustrated in comand line tool.
